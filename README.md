# 🚀 BridgeLabz Training – Core C# Practice

This repository contains my **Core C# practice work** completed during the **BridgeLabz Training Program**.  
It documents my **day-wise learning progress**, hands-on coding tasks, and fundamental programming concepts using **C# (.NET)**.
...
- **Mode:** Hands-on coding + concept-based learning
...
- No coding work on this day (orientation & fundamentals)
...
- `hello.cs` – Basic Hello World program
- `welcome.cs` – Simple welcome message
- `sum.cs` – Sum of two numbers
- `avg_of_three_numbers.cs` – Average calculation
- `simple_interest.cs` – Simple interest calculation
- `area_of_circle.cs` – Area of a circle
- `perimeter_of_rectangle.cs` – Perimeter calculation
- `volume_of_cylinder.cs` – Volume calculation
- `power_of_number.cs` – Power of a number
- `kilometers_to_miles.cs` – Unit conversion
- `celsius_to_fahrenheit.cs` – Temperature conversion
